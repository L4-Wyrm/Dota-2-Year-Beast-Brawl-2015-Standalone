...
-- physical abilities
local ABILITY_right_claw_swipe = thisEntity:FindAbilityByName( "beast_bash" )
local ABILITY_left_claw_swipe = thisEntity:FindAbilityByName( "beast_attack_speed_aura" )
local ABILITY_nian_dive = thisEntity:FindAbilityByName( "beast_spiked_carapace" )
local ABILITY_tail_spin = thisEntity:FindAbilityByName( "beast_berserkers_call" )
local ABILITY_nian_leap = thisEntity:FindAbilityByName( "" )

-- magical abilities
local ABILITY_nian_hurricane = thisEntity:FindAbilityByName( "beast_healing_aura" )
local ABILITY_nian_apocalypse = thisEntity:FindAbilityByName( "" )

local ABILITY_nian_roar = thisEntity:FindAbilityByName( "beast_stampede" )
local ABILITY_nian_charge = thisEntity:FindAbilityByName( "beast_truesight" )
local ABILITY_nian_tail_swipe = thisEntity:FindAbilityByName( "beast_smoke_aura" )

local ABILITY_nian_whirlpool = thisEntity:FindAbilityByName( "beast_greater_hex" )
local ABILITY_nian_stone_gaze = thisEntity:FindAbilityByName( "" )
local ABILITY_nian_eruption = thisEntity:FindAbilityByName( "" )
local ABILITY_nian_sigils = thisEntity:FindAbilityByName( "" )
local ABILITY_nian_waterball = thisEntity:FindAbilityByName( "beast_aegis" )
...
function DispatchOnPostSpawn()
	-- physical abilities
	ABILITY_right_claw_swipe = thisEntity:FindAbilityByName( "beast_bash" )
	ABILITY_left_claw_swipe = thisEntity:FindAbilityByName( "beast_attack_speed_aura" )
	ABILITY_nian_dive = thisEntity:FindAbilityByName( "beast_leap" )
	ABILITY_tail_spin = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_leap = thisEntity:FindAbilityByName( "" )

	-- magical abilities
	ABILITY_nian_hurricane = thisEntity:FindAbilityByName( "beast_healing_aura" )
	ABILITY_nian_apocalypse = thisEntity:FindAbilityByName( "beast_spiked_carapace" )

	ABILITY_nian_roar = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_charge = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_tail_swipe = thisEntity:FindAbilityByName( "" )

	ABILITY_nian_whirlpool = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_stone_gaze = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_eruption = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_sigils = thisEntity:FindAbilityByName( "" )
	ABILITY_nian_waterball = thisEntity:FindAbilityByName( "" )
